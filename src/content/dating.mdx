...
today is broken”, then launch an app with with some incremental user experience change:
...
{/* The new app will churn out most users in year 2-3, and eventually die out. */}
